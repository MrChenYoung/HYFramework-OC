...
- (id)initWithText:(NSString *)text{
    if (self = [super init]) {
        ...
        if ([text isEqualToString:@"已经实名认证"]) {
            _contentView.layer.borderColor = [UIColor colorWithRed:152/255.0 green:192/255.0 blue:57/255.0 alpha:1.0].CGColor;
            _contentView.backgroundColor =[UIColor colorWithRed:152/255.0 green:192/255.0 blue:57/255.0 alpha:1.0];
        }else{
